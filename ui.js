...
export const UI = (() => {
  ...
  function update(){
    ...
    // Double allowed only if 2 cards and not doubled before and if double after split allowed or not splitting
    ...
    // Split allowed only if canSplit and under max split hands
    ...
    // Surrender allowed if late surrender enabled and first move on hand (2 cards)
  ...
  // canSplit reused here (same logic as game.js)
